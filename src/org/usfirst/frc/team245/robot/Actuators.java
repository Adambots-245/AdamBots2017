...
public class Actuators {
	 ...
	 */
	// TODO: Set correct IDs, test motors individually and confirm correct
	// directions
	public static void init() {
		...
		rightDriveMotorSlave.changeControlMode(CANTalon.TalonControlMode.Follower); // setting
																					// right
																					// rear
																					// motor
																					// to
		...
		rightDriveMotorSlave.reverseOutput(false); // reversing right slave
													// motor because of gear
													// design
		...
		leftDriveMotorSlave.changeControlMode(CANTalon.TalonControlMode.Follower); // setting
																					// left
																					// rear
																					// motor
																					// to
		...
		leftDriveMotorSlave.reverseOutput(false); // reversing left slave motor
													// because of gear design
	...
	/*
	 * @return dispenseGearAdvancePneumatic values can be off, forward, or
	 * reverse
	 */
	...
	/*
	 * @return sweeperPneumatic values can be off, forward, or reverse
	 */
